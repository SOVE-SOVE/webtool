  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-20 rounded-full bg-neutral-900 px-5 py-3 text-sm font-medium text-white shadow-lg hover:bg-neutral-800"
      >
        Leave feedback
      </button>
    );
    ...
    <div className="fixed inset-0 z-20 flex items-end justify-end bg-black/20 p-4 sm:items-center sm:justify-center">
      <div className="w-full max-w-sm rounded-lg bg-white p-5 shadow-xl">
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => setOpen(false)} aria-label="Close" className="text-neutral-400 hover:text-neutral-600">
            ✕
          </button>
        </div>
        ...
        {sent ? (
          <div className="mt-4">
            <p className="text-sm text-neutral-700">Thanks — your feedback has been sent.</p>
            <button
