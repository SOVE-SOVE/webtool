...
from app.modules.businesses.schemas import BusinessCreate, BusinessRead, BusinessUpdate
...
def update_business(
    ...
    business = service.update_business(db, current_user.workspace_id, business_id, data)
    if business is None:
        raise HTTPException(status_code=404, detail="Business not found")
    return business
