...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('business_industry', sa.String(length=120), nullable=True),
        ...
        sa.Column('website_weaknesses', sa.Text(), nullable=False),
        sa.Column('website_opportunities', sa.Text(), nullable=False),
        sa.Column('lead_score', sa.Integer(), nullable=True),
        sa.Column('previous_interactions', sa.Text(), nullable=False),
        sa.Column('outreach_history', sa.Text(), nullable=False),
        sa.Column('objections', sa.Text(), nullable=False),
        sa.Column('questions_to_ask', sa.Text(), nullable=False),
        sa.Column('likely_requirements', sa.Text(), nullable=False),
        sa.Column('possible_package', sa.Text(), nullable=False),
        sa.Column('suggested_pricing_range', sa.Text(), nullable=False),
